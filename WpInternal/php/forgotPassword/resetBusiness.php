...
{          
    if($_GET['action']=="reset")
    {
        ...
        $username= $_GET['user'];
        $query = "SELECT ID FROM signup_business where email='".$username."'";
...
elseif(isset($_POST['action']))
{
    ...
    if($idEncrypy==$encrypt)
    {
        $query = "UPDATE signup_business SET password='".$password."' WHERE email='".$username."'";
...
<div class="bus_signup">
            ...
            <form class='f1' action="resetBusiness.php" method="post" id="reset">
                <fieldset>

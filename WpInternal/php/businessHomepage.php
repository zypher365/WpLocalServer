...
echo    '<script type="text/javascript">
   ...
   window.location="./businessLogin.php";
...
include("dbConn.php");
$myResult=mysqli_query($conn ,"SELECT ID FROM signup_business WHERE email='".$user."' AND password='".$wpPassword."'");
...
$_SESSION['username']=$user ;
    $_SESSION['txnid']=$orderID;
    $_SESSION['orders']=$dataEntry3;
    $_SESSION['quality']=$quality;
    $_SESSION['noOfPosts']=$dataEntry1;
    $_SESSION['deliveryTime']=$dataEntry2;
    $_SESSION['topic']=$topic;
    $_SESSION['industry_of_experience']=$industry;
    $_SESSION['goal']=$goal;
    $_SESSION['style_of_writing']=$styleOfWriting;
    $_SESSION['sample_blog']=$sampleBlog;
    $_SESSION['point_of_view']=$pointOfView;
    $_SESSION['blog_structure']=$blogStructure;
    $_SESSION['target_audience']=$targetAudience;
    $_SESSION['key_points']=$keyPoints;
    $_SESSION['things_to_avoid']=$avoid;
    $_SESSION['keywords']=$keywords;
    $_SESSION['special_instructions']=$specialInstructions;
...
<style type="text/css">
    ...
    #pay li
    {
        background-color:<?php echo $selformatBackground3 ?>;
        color:<?php echo $selcolor3 ?>;
    }
    ...
    <body  onload="submitPayuForm()">
        <div class='nav_bar-writer'>
                <ul>
                    <li id="logo"><a href="businessHomepage.php"><img src='../images/full_logo.png'/></a></li>     
                    <li id='username' name='email'><a href="#"><?php echo $_SESSION['myWpUsername']; $Username; ?>  &#x25BC;</a></li>
...
<!--                                <option value="2">3 business days, +20% surcharge</option>-->
                        ...
                        <input id='textbox' type="text" name="sampleBlog" placeholder="Link to an existing piece of content to give the writer an idea of the style of content you need"/>
                        <br/><br/><br/>
                        <h2>Point of View:</h2>
                        <p class="goal">
                        ...
                        <input name='targetAudience' type="text" id="textbox" placeholder="Describe the audience you seek to reach out to with this content"/>
                        <br/><br/><br/>
                        ...
                        <br/><br/><br/>
                        <h2>Keywords:</h2>
                        <input name="keywords" type="text" id="textbox" placeholder="List keywords and how they should be integrated into the post"/>
				    ...
				    <script type="text/javascript">
					    ...
					    document.getElementById('product_name').value = element.getAttribute('data-product-name');
                            ...
                            <form action="<?php echo $action; ?>" method="post" name="payuForm">
                              ...
                              <table style="border:solid;background-color:#2eb161;font-family:nesia; font-size:20px;color:#fff; padding: 30px 30px 30px 30px;">
                                ...
                                <tr> 
                                  <td>Email: <?php echo $_SESSION['myWpUsername'] ?> </td>
                                  <td><input type="hidden" name="email" id="email" value="<?php echo (empty($posted['email'])) ? $_SESSION['myWpUsername'] : $posted['email']; ?>" /></td>
                                ...
                                <tr>
                                  ...
                                  <td>Phone: &nbsp;<?php echo (empty($posted['phone'])) ? $mobile : $posted['phone']; ?>
                                  <input type='hidden' style="background-color:#2eb161; border:none; " name="phone" value="<?php echo (empty($posted['phone'])) ? $mobile : $posted['phone']; ?>" /></td>
                                </tr>
                                <tr>
                                ...
                                <tr style="font-size:24px;">
                                  ...
                                  <td><br>Amount: Rs.<?php echo $quality; ?></td>
...
<?php if(!$hash) { ?>
                                    <td colspan="4"><input style='background-color:#2eb161;color:#fff;font-size:20px; border-color:#2eb161; margin-left:3px; padding: 8px 8px 8px 8px;' type="submit" value="Pay Now" /></td>
                                  <?php } ?>
                            </form>
                ...
                <div class="received_content">
                    <?php include("./receivedContent.php"); ?>
                </div>

...
<html>
    ...
    <body>
        <div class="bus_login">
            ...
            <form class='f1' action="databaseCall/loginBusiness.php" method="post">
                <fieldset>
                <legend><h3>Let's get you signed in.</h3></legend>
                    
                    <input required id='other' class='textbox' type="text" name="email" placeholder='Your Email ID' ><br>
